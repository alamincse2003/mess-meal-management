...
# Reuse the app's existing SQLAlchemy metadata so 'autogenerate' can compare
...
def run_migrations_online() -> None:
    ...
    Reuses the app's existing SQLAlchemy engine (app/database.py) instead of
    creating a second, separate database connection.
